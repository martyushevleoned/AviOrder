...
import org.example.utils.WorkBoorUtils;
...
public class OrderService {
    ...
    private final WorkBoorUtils workBoorUtils;

    @Autowired
    public OrderService(UserRepository userRepository, OrderRepository orderRepository, AdvertisementRepository advertisementRepository, WorkBoorUtils workBoorUtils) {
        this.userRepository = userRepository;
        this.orderRepository = orderRepository;
        this.advertisementRepository = advertisementRepository;
        this.workBoorUtils = workBoorUtils;
    }
    ...
    public Resource generateOrderExcelDocument(long orderId) {
        ...
        try (
                Workbook workbook = workBoorUtils.generateWorkbook(orderDto);
